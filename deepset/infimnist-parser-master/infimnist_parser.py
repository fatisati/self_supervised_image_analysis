...
def main():
    ...
    parser.add_argument('-d', '--delimiter', default = ',', metavar = '', help = 'column delimiter used for the output')
    args = vars(parser.parse_args())
    convert(args['label_data'], args['image_data'], save = True, delimiter = args['delimiter'], path_out = args['output'])
    print('The dataset is written to {}'.format(args['output']))
