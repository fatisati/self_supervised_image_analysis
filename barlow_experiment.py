...
barlow_pretrain_epochs = [25, 50]
barlow_batch_sizes = [16, 32, 64]
barlow_crop_to = [128, 256]
barlow_project_dim = [2048, 1024]

barlow_fine_tune_epochs = [25, 50, 100]
barlow_fine_tune_bs = [32, 64, 128]


def fine_tune(barlow_encoder):
        ...
        for bs in barlow_batch_sizes:
            for crop_to in barlow_crop_to:
                for project_dim in barlow_project_dim:
                    ...
                    if not model_exist(pretrain_params):
