...
class FineTune:
    ...
    def get_warmup_classifier(self, input_shape, outshape, activation="softmax"):
        # input placeholder
    ...
    def warm_up(self, training_ds, inshape, outshape, epochs):
        ...
        model = self.get_warmup_classifier(inshape, outshape, activation)
    ...
    def get_fine_tune_classifier(self, inshape, warmup_model):
        # input placeholder
        inputs = Input(shape=(inshape, inshape, 3))
